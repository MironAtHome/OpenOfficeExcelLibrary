...
namespace DocumentFormat.OpenXml.Packaging
{
    ...
    public abstract class OpenXmlPart : OpenXmlPartContainer
    {
        ...
        private Uri _uri;
        private Stream _partStream = null;
        ...
        /// <summary>
        /// Indicates whether the part was opened for reading. 
        /// </summary>
        /// 

        public Stream PartStream
        {
            get { return _partStream; }
        }
        ...
        public bool IsOpened
        {
            get
            {
                ...
                else if (_partStream is System.IO.Packaging.ZipWrappingStream)
                {
                    if (((System.IO.Packaging.ZipWrappingStream)_partStream).ZipArchiveEntry == null)
                    {
                        return false;
                    }
                    else
        ...
        public FileAccess PartStreamOpenedForFileAccess
        {
            get
            {
                if (IsOpened)
                {
                    if( _partStream is System.IO.Packaging.ZipWrappingStream)
                    {
                        return ((System.IO.Packaging.ZipWrappingStream)_partStream).PackageFileAccess;
                    }
                }
        ...
        public FileMode PartStreamOpenedForFileMode
        {
            get
            {
                if (IsOpened)
                {
                    if (_partStream is System.IO.Packaging.ZipWrappingStream)
                    {
                        return ((System.IO.Packaging.ZipWrappingStream)_partStream).PackageFileMode;
                    }
                }
        ...
        {
            ThrowIfObjectDisposed();
            Debug.WriteLine(String.Format("Opening stream for part {0} with FileMode: {1} and FileAccess: {2}", this.Uri, Enum.GetName(typeof(FileMode), FileMode.OpenOrCreate), Enum.GetName(typeof(FileAccess), this.PartStreamOpenedForFileAccess)));
            Stream s = this.PackagePart.GetStream();
            _partStream = s;
            return s;
        }
        ...
        {
            ThrowIfObjectDisposed();
            Debug.WriteLine(String.Format("Opening stream for part {0} with FileMode: {1} and FileAccess: {2}", this.Uri, Enum.GetName(typeof(FileMode), mode), Enum.GetName(typeof(FileAccess), this.PartStreamOpenedForFileAccess)));
            Stream s = this.PackagePart.GetStream( mode );
            _partStream = s;
            return s;
        }
        ...
        {
            ThrowIfObjectDisposed();
            Debug.WriteLine(String.Format("Opening stream for part {0} with FileMode: {1} and FileAccess: {2}", this.Uri, Enum.GetName(typeof(FileMode), mode), Enum.GetName(typeof(FileAccess), access)));
            Stream s = this.PackagePart.GetStream(mode, access);
            _partStream = s;
            return s;
        }
